...
public class Exercise2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startColorPicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ColorPicker picker = new ColorPicker(Exercise2Activity.this);
        ...
        durationSelector.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new MaterialDialog.Builder(Exercise2Activity.this)
    ...
    private void onDurationChanged(String input) {
        ...
        if (isValid) {
            ...
            Toast.makeText(Exercise2Activity.this, R.string.invalid_duration, Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void resetTargetAnimation() {
        ...
        animatorSet.playTogether(animator1, animator2, animator4, animator3);
        animatorSet.start();
    }
}
