...
import com.example.recycler_intent.recycler.MyAdapter;
import com.example.recycler_intent.recycler.msg_item;
import com.example.recycler_intent.recycler.DataSet;
...
public class RecyclerViewActivity extends AppCompatActivity implements MyAdapter.IOnItemClickListener {
    ...
    @Override
    public void onItemCLick(int position, msg_item data) {
    ...
    @Override
    public void onItemLongCLick(int position, msg_item data) {
