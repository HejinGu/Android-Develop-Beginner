...
public class ClockView extends View {
    ...
    private void drawTimeNeedles(Canvas canvas) {
        ...
        float secondsDegree = second * UNIT_DEGREE - 90;
    ...
    private void drawCenter(Canvas canvas) {
        ...
        paint1.setStrokeWidth(Math.min(getWidth(), getHeight()) * 0.010f);
        paint1.setColor(Color.LTGRAY);
        canvas.drawCircle(centerX,centerY,20,paint1);

        Paint paint2 = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint2.setStyle(Paint.Style.STROKE);
        paint2.setStrokeWidth(6);
        paint2.setColor(Color.WHITE);
        canvas.drawCircle(centerX,centerY,20,paint2);
    }
